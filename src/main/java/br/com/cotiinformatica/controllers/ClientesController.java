...
public class ClientesController {
	...
	public ResponseEntity<GetClientesDTO> getAll(){
		return null;		
	}	
	@ApiOperation("Serviço para consulta de clientes por id.")
	@GetMapping("/api/clientes/{id}")
	public ResponseEntity<String> getById(@PathVariable("id")Integer IdCliente){
		return null;
	}
