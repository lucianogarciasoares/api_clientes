...
public class PutClientesDTO {
	...
	@Min(value = 1 , message = "Por favor, informe um id maior que zero.")
	...
	@Pattern(regexp = "^[0-9]{11}$", message = "CPF deve ter 11 digitos numéricos.")
	...
	@Pattern(regexp = "^[0-9]{11}$", message = "Telefone deve ter 11 digitos numéricos(DDD + Telefone).")
